...
const Templates: React.FC<TemplatesProps> = ({ templatesInView }) => {
  ...
  return (
    <div className="w-full h-full bg-terciary py-32">
      <div ref={bgRef} className="container mx-auto">
        <div className="text-left mb-8 relative">
          <h2 ref={h2Ref} className="text-4xl font-bold mb-2 tracking-wide">Templates Prontos</h2>
        ...
        <div className="flex flex-col gap-10 md:flex-row items-center justify-between">
          <div ref={leftSideRef} className="w-full md:w-1/2 text-left mb-8 md:mb-0 flex flex-col gap-5">
            <h2 className="text-7xl font-semibold mb-4 tracking-wide">O que são Templates</h2>
            <p className="mb-6 text-justify tracking-wide">
          ...
          <div ref={rightSideRef} className="w-full md:w-1/2 flex flex-col">
            <div className="flex items-center bg-secondary hover:bg-primary duration-300">
              <img src={landingPageImg.src} alt="Landing Pages" className="w-1/2 h-56 object-cover" />
              <div className="w-1/2 text-terciary text-7xl text-center py-4 px-6 rounded">Landing Pages</div>
            </div>
            <div className="flex items-center w-full justify-center bg-secondary text-terciary hover:bg-primary duration-300">
              <div className="text-7xl text-center py-4 px-6 rounded w-1/2">Banners</div>
              <img src={bannersImg.src} alt="Banners" className="w-1/2 h-56 object-cover" />
            </div>
          </div>
